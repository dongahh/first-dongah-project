...
public class DongahController {
	...
	/*
	 * @RequestMapping("reserve_getInfo.do") public @ResponseBody List<CDA_roomDTO>
	 ...
	 * System.out.println("num>>"+num); System.out.println("room_list>>"+room_list);
	 * 
	 * 
	 * return room_list;
	 * 
	...
	public String payment(Model model, CDA_reserveInfoDTO reserveInfoDTO) {
		...
		for (CDA_reserveInfoDTO reservedto : reserveInfoDTO.getReserveInfoDTO()) {
			 ...
			 * result.put("addpeople",reservedto.getAddpeople()); //result.put("addday",
			 * dto.getAddday());
			 */
